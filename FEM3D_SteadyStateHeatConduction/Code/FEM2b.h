...
double FEM<dim>::basis_function(unsigned int node, double xi_1, double xi_2, double xi_3){
  ...
  //EDIT
  if (node==0){value = (1./8.)*(1-xi_1)*(1-xi_2)*(1-xi_3);}
  if (node==1){value = (1./8.)*(1+xi_1)*(1-xi_2)*(1-xi_3);}
  if (node==2){value = (1./8.)*(1-xi_1)*(1+xi_2)*(1-xi_3);}
  if (node==3){value = (1./8.)*(1+xi_1)*(1+xi_2)*(1-xi_3);}
  if (node==4){value = (1./8.)*(1-xi_1)*(1-xi_2)*(1+xi_3);}
  if (node==5){value = (1./8.)*(1+xi_1)*(1-xi_2)*(1+xi_3);}
  if (node==6){value = (1./8.)*(1-xi_1)*(1+xi_2)*(1+xi_3);}
  if (node==7){value = (1./8.)*(1+xi_1)*(1+xi_2)*(1+xi_3);}
...
void FEM<dim>::define_boundary_conds(){
  ...
  for (unsigned globalNodes = 0; globalNodes<totalNodes;globalNodes++){
    if (nodeLocation[globalNodes][0]==0.){
      boundary_values[globalNodes] = 300.*(1.0+(nodeLocation[globalNodes][1]+nodeLocation[globalNodes][2])/3.0);
    }
    if (nodeLocation[globalNodes][0]==0.04){
      boundary_values[globalNodes] = 310.*(1.0+(nodeLocation[globalNodes][1]+nodeLocation[globalNodes][2])/3.0);
    }
  }
}
